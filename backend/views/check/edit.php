...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        ...
        <div class="form-group field-message-content">
            <div><label class="" for="message-content" style="width: 200px;">提交人</label><span class="help-inline"></span> <span><?=isset($model_admin->username)?$model_admin->username:'未知' ?></span> </div><span class="help-block"></span>
        </div>

        <div class="form-group field-message-content">
            <div><label class="" for="message-content" style="width: 200px;">账户余额</label><span class="help-inline"></span> <span><?=isset($model_admin->balance)?$model_admin->balance:'未知' ?></span> 条 </div><span class="help-block"></span>
        </div>
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="vertical-align: middle;"><span><?=$model_ld->phonenumbers_json['unicom'] ?></span> 条</td>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;"><span><?=$model_ld->phonenumbers_json['mobile'] ?></span> 条</td>
                        <td style="vertical-align: middle;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;"><span><?=$model_ld->phonenumbers_json['telecom'] ?></span> 条</td>
                        <td style="vertical-align: middle;">
